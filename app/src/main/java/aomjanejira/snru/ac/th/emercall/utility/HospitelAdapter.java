package aomjanejira.snru.ac.th.emercall.utility;
...
public class HospitelAdapter extends BaseAdapter{
...
//    Explicit
    ...
    public HospitelAdapter(Context context, int[] ints, String[] titleStrings, String[] phoneStrings) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView imageView = view1.findViewById(R.id.imageLisView);
